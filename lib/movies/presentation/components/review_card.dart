...
import 'package:kinobaza/movies/presentation/components/avatar.dart';
import 'package:kinobaza/movies/presentation/components/review_content.dart';
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Avatar(avatarUrl: review.avatarUrl, name: review.authorName),
                ),
                Expanded(
                  child: Column(
